...
data= pd.read_csv("02 - Elaborated Dataset/tic-tac-toe.csv")
...
df.to_csv("03 - Results/CSV/Tic_Tac_Toe_Evaluation_Results.csv")
dfcvKF3.to_csv("03 - Results/CSV/Tic_Tac_Toe_Evaluation_Results_CVKFOLD3.csv")
dfcvKF5.to_csv("03 - Results/CSV/Tic_Tac_Toe_Evaluation_Results_CVKFOLD5.csv")
dfcvKF10.to_csv("03 - Results/CSV/Tic_Tac_Toe_Evaluation_Results_CVKFOLD10.csv")

read_file = pd.read_csv("03 - Results/CSV/Tic_Tac_Toe_Evaluation_Results.csv")
read_file2 = pd.read_csv("03 - Results/CSV/Tic_Tac_Toe_Evaluation_Results_CVKFOLD3.csv")
read_file3 = pd.read_csv("03 - Results/CSV/Tic_Tac_Toe_Evaluation_Results_CVKFOLD5.csv")
read_file4 = pd.read_csv("03 - Results/CSV/Tic_Tac_Toe_Evaluation_Results_CVKFOLD10.csv")

with pd.ExcelWriter('03 - Results/XLSX/Tic_Tac_Toe_Evaluation_Results.xlsx') as writer:
