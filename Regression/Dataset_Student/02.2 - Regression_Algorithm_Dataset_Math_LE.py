...
df.to_csv("03 - Results/03.2 - LabelEncoding/CSV/Students_Math_Regression_Evaluation_Results_LE.csv")
dfcvKF3.to_csv("03 - Results/03.2 - LabelEncoding/CSV/Students_Math_Regression_Evaluation_Results_LE_CVKFOLD3.csv")
dfcvKF5.to_csv("03 - Results/03.2 - LabelEncoding/CSV/Students_Math_Regression_Evaluation_Results_LE_CVKFOLD5.csv")
dfcvKF10.to_csv("03 - Results/03.2 - LabelEncoding/CSV/Students_Math_Regression_Evaluation_Results_LE_CVKFOLD10.csv")

read_file = pd.read_csv("03 - Results/03.2 - LabelEncoding/CSV/Students_Math_Regression_Evaluation_Results_LE.csv")
read_file2 = pd.read_csv("03 - Results/03.2 - LabelEncoding/CSV/Students_Math_Regression_Evaluation_Results_LE_CVKFOLD3.csv")
read_file3 = pd.read_csv("03 - Results/03.2 - LabelEncoding/CSV/Students_Math_Regression_Evaluation_Results_LE_CVKFOLD5.csv")
read_file4 = pd.read_csv("03 - Results/03.2 - LabelEncoding/CSV/Students_Math_Regression_Evaluation_Results_LE_CVKFOLD10.csv")

with pd.ExcelWriter('03 - Results/03.2 - LabelEncoding/XLSX/Students_Math_Regression_Evaluation_Results_LE.xlsx') as writer:
