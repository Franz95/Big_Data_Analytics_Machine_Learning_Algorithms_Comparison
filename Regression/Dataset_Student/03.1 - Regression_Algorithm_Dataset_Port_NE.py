...
df.to_csv("03 - Results/03.1 - NoEncoding/CSV/Students_Port_Regression_Evaluation_Results_NE.csv")
dfcvKF3.to_csv("03 - Results/03.1 - NoEncoding/CSV/Students_Port_Regression_Evaluation_Results_NE_CVKFOLD3.csv")
dfcvKF5.to_csv("03 - Results/03.1 - NoEncoding/CSV/Students_Port_Regression_Evaluation_Results_NE_CVKFOLD5.csv")
dfcvKF10.to_csv("03 - Results/03.1 - NoEncoding/CSV/Students_Port_Regression_Evaluation_Results_NE_CVKFOLD10.csv")

read_file = pd.read_csv("03 - Results/03.1 - NoEncoding/CSV/Students_Port_Regression_Evaluation_Results_NE.csv")
read_file2 = pd.read_csv("03 - Results/03.1 - NoEncoding/CSV/Students_Port_Regression_Evaluation_Results_NE_CVKFOLD3.csv")
read_file3 = pd.read_csv("03 - Results/03.1 - NoEncoding/CSV/Students_Port_Regression_Evaluation_Results_NE_CVKFOLD5.csv")
read_file4 = pd.read_csv("03 - Results/03.1 - NoEncoding/CSV/Students_Port_Regression_Evaluation_Results_NE_CVKFOLD10.csv")

with pd.ExcelWriter('03 - Results/03.1 - NoEncoding/XLSX/Students_Port_Regression_Evaluation_Results_NE.xlsx') as writer:
